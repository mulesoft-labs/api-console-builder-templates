...
class ApiConsoleTemplatesProcessor {
  ...
  /**
   * Sets a name of the template to be used with current build of the API console.
   *
   ...
   * @return {Promise} Resolved promise after the template variables were updated.
   */
   ...
   * directory and not in the build's root path.
   *
   ...
   * also the default value. It must be relative path from project's root folder.
